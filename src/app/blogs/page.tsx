        ...
        >
            <div className="max-w-7xl mx-auto px-6 md:px-12 py-24 bg-gray-50">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
                        { date: "Oct 12, 2024", title: "The Science behind Fe-550D TMT Bars", category: "Metallurgy", read: "5 Min Read" },
                        { date: "Nov 02, 2024", title: "Why Ductility Matters in Earthquake Zones", category: "Civil Engineering", read: "8 Min Read" },
                        { date: "Dec 15, 2024", title: "KAAVERI Receives Global Green Steel Accreditation", category: "Company News", read: "4 Min Read" },
                        { date: "Jan 10, 2025", title: "Exploring Next-Gen Quenching Technologies", category: "Technology", read: "6 Min Read" },
                        { date: "Feb 05, 2025", title: "Building Skyscraper Cores: Best Practices", category: "Construction", read: "7 Min Read" },
                        { date: "Mar 01, 2025", title: "How to identify Genuine TMT Bars on Site", category: "Quality Guide", read: "5 Min Read" }
                    ].map((blog, i) => (
                        <motion.article
                            key={i}
